...
if __name__ == "__main__":
    # Die neue DB (mit neuem Schema) heißt cards_database.sqlite
    # Die Ziel-DB wird als cards_database_original_Scheme.sqlite erstellt
    new_db = "cards_database.sqlite"
    old_schema_db = "cards_database_original_Scheme.sqlite"
